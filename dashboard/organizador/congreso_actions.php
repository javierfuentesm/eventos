...
try
{
	...
	if($_GET["action"] == "list")
	{
		...
		$result = mysql_query("SELECT * FROM evento,congreso where evento.id_evento=congreso.id_evento;");
	...
	else if($_GET["action"] == "update")
	{
		...
		$result = mysql_query("UPDATE congreso SET id_memoria = '" . $_POST["id_memoria"] ."' WHERE id_evento = " . $_POST["id_evento"] . ";");
