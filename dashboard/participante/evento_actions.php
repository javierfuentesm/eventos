...
try
{
	...
	if($_GET["action"] == "list")
	{
		...
		$result = mysql_query("SELECT * FROM evento,registro where evento.id_evento=registro.id_evento;");
	...
	else if($_GET["action"] == "delete")
	{
		...
		$result = mysql_query("DELETE FROM registro WHERE id_evento = " . $_POST["id_evento"] . ";");
