...
--
-- Table structure for table `no_socio`
--

DROP TABLE IF EXISTS `no_socio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `no_socio`
--

LOCK TABLES `no_socio` WRITE;
/*!40000 ALTER TABLE `no_socio` DISABLE KEYS */;
/*!40000 ALTER TABLE `no_socio` ENABLE KEYS */;
UNLOCK TABLES;
